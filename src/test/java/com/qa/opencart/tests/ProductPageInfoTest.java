...
public class ProductPageInfoTest extends BaseTest{
	...
	//{Brand=Apple, Availability=In Stock, extTaxprice=$2,000.00, Product Code=Product 18, 
	...
	//productprice=$2,000.00, extTaxprice=$2,000.00, productname=MacBook Pro} -- LinkedHashMap
	
	//{Availability=In Stock, Brand=Apple, Product Code=Product 18, Reward Points=800, 
	//extTaxprice=$2,000.00, productname=MacBook Pro, productprice=$2,000.00} -- TreeMap
